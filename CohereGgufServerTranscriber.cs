...
namespace WhisperInk
{
    ...
    /// Lazy-started on first TranscribeAsync call. Port 8766.
    ///
    ...
    /// </summary>
    public sealed class CohereGgufServerTranscriber : IDisposable
    {
        ...
        private const int    ServerPort = 8766;
        ...
        public CohereGgufServerTranscriber() : this(ExePath, DefaultModel) { }

        public CohereGgufServerTranscriber(string exePath, string modelPath, int threads = 0)
        {
            _exePath   = exePath;

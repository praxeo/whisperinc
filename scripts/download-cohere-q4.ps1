...
$dst = Join-Path $dir "cohere-transcribe-q4_k.gguf"
...
if (Test-Path $dst) {
    ...
    & curl.exe -L --fail -o $dst "https://huggingface.co/cstr/cohere-transcribe-03-2026-GGUF/resolve/main/cohere-transcribe-q4_k.gguf"
